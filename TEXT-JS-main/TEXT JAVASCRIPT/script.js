document.getElementById (" formulario-tarea").addEventListener("submit", function (event) {
  ...
  {
    alert(" Complete todos los campos para crear una nueva tarea,por favor.");
    return;
  }
...
document.addEventListener("DOM", () => {
  ...
  if (formTarea) {formTarea.addEventListener("submit", async (e) => {
      e.preventDefault();
      ...
      const crearTarea =  document.getElementById (" crear").value;
